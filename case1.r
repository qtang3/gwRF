...
class_l[intersect(which(x1_l>7),which(x2_l<5.3))] = 'a'
class_l[intersect(which(x1_l>7),which(x2_l>5.3))] = 'b'
class_l[intersect(which(x1_l<7),which(x3_l>0))] = 'a'
class_l[intersect(which(x1_l<7),which(x3_l<0))] = 'b'


class_r[which(x3_r>0)] = 'a'
class_r[intersect(which(x3_r<0),which(x2_r<5.3))] = 'b'
class_r[intersect(intersect(which(x3_r<0),which(x2_r>5.3)), which(x1_r>4))] = 'a'
class_r[intersect(intersect(which(x3_r<0),which(x2_r>5.3)), which(x1_r<4))] = 'b'
